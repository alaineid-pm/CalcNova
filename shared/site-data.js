...
var CALCNOVA_ARTICLES = [
  ...
  {
    id:            'article-mortgage',
    name:          'How to Choose the Right Mortgage',
    emoji:         '🏠',
    url:           'article-mortgage.html',
    description:   'Fixed-rate vs. adjustable, 15 vs. 30 years, points, PMI — everything you need to know before signing for a home loan.',
    readTime:      '7 min',
    category:      'guides',
    subcategory:   'Housing',
  ...
  },
  {
    ...
    description:   'Sleep recommendations by age, the science of sleep cycles, effects of sleep deprivation, and tips to improve sleep quality.',
    readTime:      '6 min',
    category:      'guides',
